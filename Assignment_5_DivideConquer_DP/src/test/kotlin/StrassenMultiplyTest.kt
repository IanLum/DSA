...
class StrassenMultiplyTest {
    ...
    fun multiply2x2() {
        ...
        assertTrue(out contentDeepEquals m.strassenMultiply(n).getAll())
    }
    ...
    fun identity2x2() {
        ...
        assertTrue(m.getAll() contentDeepEquals m.strassenMultiply(n).getAll())
    }
